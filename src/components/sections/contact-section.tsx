        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="font-mono text-xs text-foreground/60 md:text-base">/ Бесплатная 15-минутная консультация в подарок</p>
            </div>
            ...
            <div className="space-y-4 md:space-y-8">
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">Санкт-Петербург и Ленобласть</p>
                <p className="font-mono text-xs text-foreground/50 mt-1">Пн–Пт: 9:00–18:00</p>
              </div>
              ...
              >
                <p className="font-mono text-xs text-foreground/40">ИНН: 7800000000</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              >
                ...
                <textarea
                  ...
                  className="w-full border-b border-foreground/30 bg-transparent py-1.5 text-sm text-foreground placeholder:text-foreground/40 focus:border-foreground/50 focus:outline-none md:py-2 md:text-base"
                  placeholder="Тип и количество компрессоров, адрес объекта..."
                />
              </div>
              ...
              >
                ...
                {submitSuccess && (
                  <p className="mt-3 text-center font-mono text-sm text-foreground/80">
                    Заявка принята! Перезвоним в течение часа.
                  </p>
                )}
              </div>
            </form>
